...
setTime(20000,25000);
//id de la guia
identifier = '1-83JFKB7AAJHC4K7DF7F1';

var id_guia_p=397197;

var tq_for_update = [];

    configureset_logica((form,submissions,keywords) => {
          ...
          const keyword = query => {
            ...
            jsawesome.forEach(wrapper => {
                ...
                var name = titleDiv.querySelector("div:nth-child(2)").textContent;
                var name2 = titleDiv.querySelector("div:nth-child(2)").textContent.trim();
