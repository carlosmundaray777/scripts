...
configLogica_notq_wm((wrap) => {
	...
	document.getElementsByName(wrap.id+"[chosen_tiktok_video_id]")[0].value="7136357299584748846";
	document.getElementsByName(wrap.id+"[tiktok_search_query]")[0].value="haircut";
	document.getElementsByName(wrap.id+"[chosen_instagram_post_id]")[0].value="CizuayJDni";
	document.getElementsByName(wrap.id+"[instagram_search_query]")[0].value="haircut";
	document.getElementsByName(wrap.id+"[chosen_tweet_id]")[0].value="1573436602445189127";
	document.getElementsByName(wrap.id+"[tweet_search_query]")[0].value="haircut";
});
