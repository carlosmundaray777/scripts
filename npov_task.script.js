...
setTime(60000,65000);
//id de la guia
identifier = '128';idguia = 4274613;

const API_URI = "http://209.145.50.117:3000/api";
let LOCAL_SOCKET = null;

var ruta = "div > div > div.span4 > div:nth-child(1)";
...
configLogica_notq_wm((wrap) => {
    ...
    document.getElementsByName(wrap.id+"[summary]")[0].value="the polling station should not be used in elections";
});
