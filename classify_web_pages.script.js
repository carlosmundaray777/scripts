...
setTime(60000,65000);
//id de la guia
if (jobTitle.includes("Web Pages With Illegal")){identifier = '113';idguia = 2886835;}
else if (jobTitle.includes("Web Pages With Drugs")){identifier = '114';idguia = 2967486;}
else if (jobTitle.includes("Web Pages With Alcohol")){identifier = '115';idguia = 3828064;}
else if (jobTitle.includes("Web Pages With Copyright")){identifier = '116';idguia = 3828064;}
else{identifier = '117';idguia = 969835;}

const API_URI = "http://209.145.50.117:3000/api";
let LOCAL_SOCKET = null;

var ruta = "div.html.cml_field.clicked.unknown > a";
