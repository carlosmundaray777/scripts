    ...
    for (var preg of pares_content.entries()) {
        ...
        if (indice !== -1) {
            ...
            radios[indice]?.click();
                    ...
                    var segundo=wrap.querySelectorAll(".cml_row select");

                    for(var i=0; i<segundo[0].length; i++){
                        var r1=trato_especial(segundo[0].options[i].value,100);
                        var r2=trato_especial("Disability", 100);
                        if(r2==r1){
                            segundo[0].selectedIndex=i;
                            segundo[0].selected = true;
                        }

                    }  
    
    
                        for(var i=0; i<segundo[1].length; i++){
                        var r1=trato_especial(segundo[1].options[i].value,100);
                        var r2=trato_especial("Neutral", 100);
                        if(r2==r1 && r2!=""){
                            segundo[1].selectedIndex=i;
                            segundo[1].selected = true;
                        }
