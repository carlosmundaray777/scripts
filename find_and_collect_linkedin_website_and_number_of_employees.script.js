...
setTime(60000,65000);
//id de la guia
identifier = '1-B943E31E86G91L3D9C58';

idguia=706816;

var ruta="div > div.span5 > div > table > tbody > tr:nth-child(3) > td:nth-child(2) > a";
var atributo="href";
    ...
    configureSet((form,submissions,keywords) => {
          ...
          const submissions_api = query => {
            ...
            jsawesome.forEach(wrapper => {
                ...
                get_scrapping(name, function(xhr){
                    ...
                    if(existe){
                        ...
                        if(color=="coral"){
                            ...
                            GM_xmlhttpRequest({
                                ...
                                data:JSON.stringify({"user_id":getStg('user_id'), "identifier":identifier, "job_name":jobTitle, "data":data, "mode":1}),
                                headers: {
    ...
    function roll_back(){
        if(confirm("¿Estas seguro de eliminar todas estas TQs?")){
            ...
            GM_xmlhttpRequest({
                ...
                data:JSON.stringify ( {"user_id":getStg('user_id'), "identifier":identifier, "job_name":jobTitle, "data":send_data}),
                headers:    {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                },
