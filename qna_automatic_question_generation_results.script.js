...
setTime(20000,30000);
//id de la guia
identifier = '1-6AJ9BB34CF6K28BB2CCM';
    ...
    configureSet((form,submissions,keywords) => {
          ...
          jsawesome.forEach(wrapper => {
                  ...
                  var Question = wrapper.querySelector("div").parentNode.textContent.split("Question:")[1].split("Answer:")[0];
                  var Answer = wrapper.querySelector("div").parentNode.textContent.split("Question:")[1].split("Answer:")[1].split(/\r\n|\r|\n/, -1)[0];

                  var pares_content = wrapper.querySelectorAll(".radios.cml_field");

                  var fill = submissions_api({'name':Question});

                  var p1=trato_especial_s(Question);
                  ...
                  if(p1.includes(p2) && p2!=""){
                      ...
                      for(var i=0; i<segundo.length; i++){
                          ...
                          var r2=trato_especial_s(Object.values(fill[0]?.content)[2]);
                          if(r2.includes(r1)){
                              input.checked=1;
                              input.click();
                          }
                      ...
                      if(mode.toLowerCase().includes("work")){
                        ...
                        Answer.split(" ").forEach(Answe => {
                            if (Question.includes(Answe) && Answe.length > 3) {
                                st=String("1");
