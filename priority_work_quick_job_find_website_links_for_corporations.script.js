...
setTime(60000,65000);
//id de la guia
identifier = '1-152G1F6474AACFK1G76G';
                ...
                if(mode.includes("work") && tq_found?.length >= 1){
                        ...
                        tq_for_update_no_existe.forEach(wrapper=>{
                            if (!wrapper.classList.contains('tq_found')) {
                                ...
                                document.getElementsByName(wrapper.id+"[website_open]")[0].click();
                                document.getElementsByName(wrapper.id+"[exec_find]")[1].click();
                                document.getElementsByName(wrapper.id+"[board_find]")[0].click();
                                document.getElementsByName(wrapper.id+"[board_link]")[0].value=e.href;*/
                                var primero2 = document.getElementsByName(wrapper.id+"[website_open]");
