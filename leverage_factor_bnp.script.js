    ...
    configureSet((form,submissions,keywords) => {
          ...
          const submissions_api = query => {
            ...
            jsawesome.forEach(wrapper => {
                ...
                let code = name?.replace("Find the LEVIER for this ISIN","")?.trim();
...
function scraping(wrapper, code){
                    ...
                    GM_xmlhttpRequest({
                        method: "GET",
                            url: "https://www.produitsdebourse.bnpparibas.fr/products/?q="+code,
                                    headers:    {
                                        "Content-Type": "application/json",
                                        "Accept": "application/json"
                                    },
                                                        ...
                                                        url: response.finalUrl,
                                                                headers:    {
                                                                    ...
                                                                    onload: function(r) {
                                                                        ...
                                                                        var buscador="quote__value";
                                                                        let num_is=buscarCode(cadena, "quote__value").match(/(\d+)/g);
                                                                        let num=buscarCode(cadena, "quote__value")[0].replace(/[<>span/]/g, '');
                                                                        ...
                                                                        if (num_is==null) {
                                                                            ...
                                                                            document.getElementsByName(wrapper.id+"[please_enter_the_partizipationsfaktor]")[0].value=num_is[0];  
                                                                        }
