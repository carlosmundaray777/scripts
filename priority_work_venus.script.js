...
setTime(60000,65000);
//id de la guia
identifier = '1-2G23L6F2HCC4K6FG47G5';
                ...
                if(mode.includes("work") && tq_found?.length >= 1){
                        ...
                        tq_for_update_no_existe.forEach(wrapper=>{
                            if (!wrapper.classList.contains('tq_found')) {
                                ...
                                document.getElementsByName(wrapper.id+"[gender_value]")[c].click();
                                document.getElementsByName(wrapper.id+"[picture]")[0].click();
                                document.getElementsByName(wrapper.id+"[source_website]")[0].value=e.href;
                            }    
                        });
