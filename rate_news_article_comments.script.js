...
setTime(30000,35000);
//id de la guia
identifier = '1-C16E22C6C44JBKH5M182';
    ...
    configureSet((form,submissions,keywords) => {
          ...
          const keyword = query => {
            ...
            jsawesome.forEach(wrapper => {
                ...
                var name = titleDiv.querySelector("table > tbody > tr:nth-child(1) > td").textContent;
                var name2 = titleDiv.querySelector("table > tbody > tr:nth-child(1) > td").textContent.trim();
                                            ...
                                            if(!mode.toLowerCase().includes("work")){
                                                if(typeof(keywordfill[0])!='undefined') {
                                                    if(typeof(keywordfill[0].respuesta)=="string"){
                                                        ...
                                                        titleDiv.scrollIntoView({ block: "center" });
                                                        let stname=keywordfill[0].name;
                                                        let st=keywordfill[0].respuesta.split(">");
                                                        var flag=false;
                                                        var input=wrapper.querySelectorAll(".checkboxes.cml_field");


                                                        if (trato_especial_s(st[0])==trato_especial_s("yes")) {
                                                            document.getElementsByName(wrapper.id+"[remove]")[0].click();
                                                            var pr=wrapper.querySelectorAll(".checkboxes.cml_field input");
                                                            pr.forEach(input =>{
                                                                st.forEach(s => {
                                                                    let r1=trato_especial_s(input.value);
                                                                    let r2=trato_especial_s(s);
                                                                    if(r1==r2){
                                                                        flag=true;
                                                                        input.click();
                                                                    }
                                                            ...
                                                            document.getElementsByName(wrapper.id+"[remove]")[1].click();
                                                        }


                                                        if (trato_especial_s(st[1])==trato_especial_s("yes")) {
                                                            document.getElementsByName(wrapper.id+"[promote]")[0].click();
                                                            var pr=wrapper.querySelectorAll(".checkboxes.cml_field input");
                                                            pr.forEach(input =>{
                                                                st.forEach(s => {
                                                                    let r1=trato_especial_s(input.value);
                                                            ...
                                                            document.getElementsByName(wrapper.id+"[promote]")[1].click();
                                                        }
