...
var palabra = trato_especial(find_query(wrap, ruta, atributo))?.replace("1.businessname","")?.replace("http","")?.replace("https","")?.replace(/[$.]/g,'').replace(/[$,]/g,'');
document.getElementsByName(wrap.id+"[company_match]")[0].click();
document.getElementsByName(wrap.id+"[domain]")[0].value=palabra+".com";
document.getElementsByName(wrap.id+"[active_domain]")[0].click();    
