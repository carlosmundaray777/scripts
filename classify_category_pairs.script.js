...
setTime(30000,35000);
//id de la guia
identifier = '1-BBCMD7GDEJ6KH14FMM7M';

var id_guia_p=418178;
    ...
    configureSet((form,submissions,keywords) => {
          ...
          const keyword = query => {
            ...
            jsawesome.forEach(wrapper => {
                ...
                var name = titleDiv.querySelector("div.html-element-wrapper > p:nth-child(1)").textContent;
                var name2 = titleDiv.querySelector("div.html-element-wrapper > p:nth-child(1)").textContent.trim();
